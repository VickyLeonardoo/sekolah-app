    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <form method="POST" action="{{ route('teacher.update',$teacher) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="identity_no" class="block mt-1 w-full" type="text" name="identity_no"
                            value="{{ $teacher->user->identity_no }}" required autofocus autocomplete="identity_no" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                            value="{{ $teacher->user->name }}" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone"
                            value="{{ $teacher->user->phone }}" required autofocus autocomplete="phone" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                            value="{{ $teacher->user->email }}" required autofocus autocomplete="email" />
