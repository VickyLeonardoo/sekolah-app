        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-2xl sm:rounded-xl overflow-hidden border-t-4 border-indigo-500">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8 md:p-10 flex flex-col gap-y-6 relative">
                    ...
                    <div class="absolute transform rotate-45 bg-green-600 text-center text-white font-semibold py-1 right-[-35px] top-[32px] w-[170px] shadow-lg">
                        Pending
                    </div>
                    @elseif($transaction->status == 'cancelled')\
                    <div class="absolute transform rotate-45 bg-red-600 text-center text-white font-semibold py-1 right-[-35px] top-[32px] w-[170px] shadow-lg">
                        Dibatalkan
                    </div>
                    ...
                    <div class="flex justify-between items-center border-b pb-4 mb-2">
                        ...
                        <div class="flex items-center space-x-3 mr-10">
                            @if ($transaction->status == 'pending')
                                <form action="{{ route('client.transaction.cancel', $transaction->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan transaksi ini?');" class="inline">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="px-4 py-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition-colors flex items-center">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            @foreach ($selectedMonths as $month)
                                <div class="bg-white border border-gray-200 rounded-md p-3 text-center hover:bg-indigo-50 transition-colors">
