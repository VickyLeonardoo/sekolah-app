    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <form method="POST" action="{{ route('academic-year.update',$academicYear) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="start_year" class="block mt-1 w-full" type="number" name="start_year"
                            value="{{ $academicYear->start_year }}" required autofocus autocomplete="start_year" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="end_year" class="block mt-1 w-full" type="number" name="end_year"
                            value="{{ $academicYear->end_year }}" required autofocus autocomplete="end_year" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="start_month" class="block mt-1 w-full" type="number" name="start_month"
                            value="{{ $academicYear->start_month }}" required autofocus autocomplete="start_month" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="end_month" class="block mt-1 w-full" type="number" name="end_month"
                            value="{{ $academicYear->end_month }}" required autofocus autocomplete="end_month" />
